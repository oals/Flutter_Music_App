...
class _HLSStreamPageState extends State<HLSStreamPage> {
  ...
  late Future<bool> _setAudioPlayerFuture;
  ...
  Future<void> _initializePlayer() async {
    ...
    _setAudioPlayerFuture = Provider.of<PlayerProv>(context, listen: false).setAudioPlayer(trackProv);
        ...
        child: ValueListenableBuilder<bool>(
            ...
            builder: (context, value, child) {
              ...
              return FutureBuilder<bool>(
                future: _setAudioPlayerFuture, // 비동기 메소드 호출
                builder: (context, snapshot) {
                  ...
                  int index = trackProv.trackModel.trackList.indexWhere((item) => item.trackId.toString() == trackProv.lastTrackId);
                    /// trackProv.trackList == 현재 내가 보고 있는 화면의 트랙들
                  if (index == -1) {
