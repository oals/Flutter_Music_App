                                    ...
                                    GestureDetector(
                                      ...
                                      child: ClipOval(
                                        child: CachedNetworkImage(
                                          imageUrl: imageProv.imageLoader(childCommentModel.memberImagePath),  // 이미지 URL
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          ...
                                          child: ClipOval(
                                            child: CachedNetworkImage(
                                              imageUrl: imageProv.imageLoader(childCommentModel.childComment?[i].memberImagePath),  // 이미지 URL
                                              placeholder: (context, url) {
